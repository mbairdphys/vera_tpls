...
IF ( QT_URL ) 
    ...
    SET( QT_CMAKE_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/qt-${QT_VERSION}" )
...
IF (ENABLE_SHARED)
  SET(QT_INSTALL_CMND
    "${PROJECT_SOURCE_DIR}/install_and_remove_static_libs.sh" "${QT_INSTALL_DIR}")
ELSE()
  SET(QT_INSTALL_CMND
    "${PROJECT_SOURCE_DIR}/install_and_remove_shared_libs.sh" "${QT_INSTALL_DIR}")
ENDIF()
PRINT_VAR(QT_INSTALL_CMND)
...
IF ( CMAKE_BUILD_QT )
    EXTERNALPROJECT_ADD( 
        ...
        INSTALL_COMMAND     ${QT_INSTALL_CMND}
